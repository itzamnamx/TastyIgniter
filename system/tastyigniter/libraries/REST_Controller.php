...
abstract class REST_Controller extends MX_Controller {
    ...
    {
        log_message('info','ANTES el constructor REST ');
        parent::__construct();
        log_message('info','DESPUES el constructor REST ');
        ...
        log_message('info','How is this request being made? GET, POST, PATCH, DELETE, INSERT, PUT, HEAD or OPTIONS ');
        ...
        log_message('info','When there is no specific override for the current class/method, use the default auth value set in the config ');
